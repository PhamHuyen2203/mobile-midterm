...
public class ProductAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tvPromotionalPrice = convertView.findViewById(R.id.tvPromotionalPrice);
        ...
        if (TextUtils.isEmpty(description)) {
            holder.tvDescription.setText(R.string.no_product_description);
        } else {
            holder.tvDescription.setText(description);
        }

        holder.tvOriginalPrice.setText(context.getString(R.string.format_price, product.getOriginalPrice()));
        holder.tvOriginalPrice.setPaintFlags(holder.tvOriginalPrice.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);

        holder.tvPromotionalPrice.setText(context.getString(R.string.format_price, product.getPromotionalPrice()));
        holder.tvRating.setText(context.getString(R.string.format_rating, product.getRating()));
